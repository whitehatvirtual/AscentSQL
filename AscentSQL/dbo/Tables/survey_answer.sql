CREATE TABLE [dbo].[survey_answer] (
    ...
    CONSTRAINT [PK_survey_answer_suvey_answer_id] PRIMARY KEY CLUSTERED ([survey_answer_id] ASC),
    CONSTRAINT [FK_survey_answer_answer] FOREIGN KEY ([answer_id]) REFERENCES [dbo].[answer] ([answer_id]),
    CONSTRAINT [FK_survey_answer_survey] FOREIGN KEY ([survey_id]) REFERENCES [dbo].[survey] ([survey_id])
);
