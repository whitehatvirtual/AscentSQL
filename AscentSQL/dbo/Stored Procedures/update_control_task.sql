...
-- =============================================
CREATE PROCEDURE [dbo].[update_control_task] 
...
BEGIN
	...
	using (
			...
			FROM OPENJSON (@jsonVariable, N'$.security_compliance_calendar_control_task_detail')
			with (
	...
	--			)
		output	 inserted.task_id, $action INTO @sp_out
